...
const totalPages = Math.ceil(filteredStockItems.length / itemsPerPage);
  ...
  const loadStock = async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_SELLER_API_URL}/api/seller/fish?seller_id=${encodeURIComponent(seller_id)}`
      );
  ...
  const loadCategories = async () => {
    try {
      const res = await fetch(
        `${process.env.REACT_APP_SELLER_API_URL}/api/seller/categories?seller_id=${encodeURIComponent(seller_id)}`
      );
      const data = await res.json();
      setCategories(data);
    } catch (err) {
  ...
  const handleAddCategory = async () => {
    ...
    try {
      const res = await fetch(`${process.env.REACT_APP_SELLER_API_URL}/api/seller/categories`, {
        method: "POST",
  ...
  const addFishProduct = async () => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.REACT_APP_SELLER_API_URL}/api/seller/add-fish`, {
        method: "POST",
        body: formDataToSend,
      });
  ...
  const updateStock = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.REACT_APP_SELLER_API_URL}/api/seller/fish/${editingItem.id}`,
        {
          method: "PUT",
          body: formDataToSend,
        }
